...
class HamburgerSettingsScreen extends ConsumerStatefulWidget {
  const HamburgerSettingsScreen({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _HamburgerSettingsScreenState();
}

class _HamburgerSettingsScreenState
    extends ConsumerState<HamburgerSettingsScreen> {
