...
abstract class APIServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.GetUserResponse> getUser(
      $grpc.ServiceCall call, $0.GetUserRequest request,); //Done - UserHandler
  $async.Future<$0.GetUserCoursesResponse> getUserCourses(
      $grpc.ServiceCall call,
      $0.GetUserCoursesRequest request,); //Done - UserHandler
  $async.Future<$0.GetUserPinnedResponse> getUserPinned($grpc.ServiceCall call,
      $0.GetUserPinnedRequest request,); //Done - PinnedHandler
  $async.Future<$0.GetUserAdminResponse> getUserAdminCourses(
      $grpc.ServiceCall call,
      $0.GetUserAdminRequest request,); //Done - UserHandler
  $async.Future<$0.GetUserSettingsResponse> getUserSettings(
      $grpc.ServiceCall call,
      $0.GetUserSettingsRequest request,); //Done - UserHandler
  $async.Future<$0.GetBookmarksResponse> getUserBookmarks(
      $grpc.ServiceCall call,
      $0.GetBookmarksRequest request,); //Done - BookmarksHandler
  $async.Future<$0.PostPinnedResponse> postUserPinned($grpc.ServiceCall call,
      $0.PostPinnedRequest request,); //Done - PinnedHandler
  $async.Future<$0.PutBookmarkResponse> putUserBookmark($grpc.ServiceCall call,
      $0.PutBookmarkRequest request,); //Done - BookmarksHandler
  $async.Future<$0.PatchBookmarkResponse> patchUserBookmark(
      $grpc.ServiceCall call,
      $0.PatchBookmarkRequest request,); //Done - BookmarksHandler
  $async.Future<$0.DeleteBookmarkResponse> deleteUserBookmark(
      $grpc.ServiceCall call,
      $0.DeleteBookmarkRequest request,); //Done - BookmarksHandler
  $async.Future<$0.DeletePinnedResponse> deleteUserPinned(
      $grpc.ServiceCall call,
      $0.DeletePinnedRequest request,); //Done - PinnedHandler
  $async.Future<$0.GetBannerAlertsResponse> getBannerAlerts(
      $grpc.ServiceCall call,
      $0.GetBannerAlertsRequest request,); //TODO - NotificationsHandler
  $async.Future<$0.GetFeatureNotificationsResponse> getFeatureNotifications(
      $grpc.ServiceCall call,
      $0.GetFeatureNotificationsRequest request,); //TODO - NotificationsHandler
  $async.Future<$0.GetPublicCoursesResponse> getPublicCourses(
      $grpc.ServiceCall call,
      $0.GetPublicCoursesRequest request,); //Done - CourseHandler
  $async.Future<$0.GetSemestersResponse> getSemesters($grpc.ServiceCall call,
      $0.GetSemestersRequest request,); //Done - CourseHandler
  $async.Future<$0.GetStreamResponse> getStream($grpc.ServiceCall call,
      $0.GetStreamRequest request,); //TODO - StreamHandler
  $async.Future<$0.GetNowLiveResponse> getNowLive($grpc.ServiceCall call,
      $0.GetNowLiveRequest request,); //TODO - StreamHandler
  $async.Future<$0.GetThumbsVODResponse> getThumbsVOD($grpc.ServiceCall call,
      $0.GetThumbsVODRequest request,); //TODO - StreamHandler
  $async.Future<$0.GetThumbsLiveResponse> getThumbsLive($grpc.ServiceCall call,
      $0.GetThumbsLiveRequest request,); //TODO - StreamHandler
}
